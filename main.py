...
#         # elif local == 4:
#         #     os.system('clear')
#         #     cliente_controller = Controller.ControllerCliente()
#         #     print('= = = = = CLIENTES = = = = = \n')
#         #     while True:
#         #         escolha = int(input(
...
#         #             cliente_controller.cadastrar_cliente(nome, cpf, telefone, email, endereco)
#         #             pass
#         #         elif escolha == 2:
#         #             os.system('clear')
#         #             cpf_cliente = input('Digite o CPF do cliente que deseja remover: ')
#         #             cliente_controller.remover_cliente(cpf_cliente)
#         #             pass
#         #         elif escolha == 3:
#         #             os.system('clear')
#         #             nome_atual = input('Qual é o nome do cliente que deseja alterar? ')
...
#         #             cliente_controller.atualizar_cliente(nome_atual, novo_nome, novo_cpf, novo_telefone, novo_email, novo_endereco)
#         #         elif escolha == 4:
#         #             os.system('clear')
#         #             cliente_controller.visualizar_clientes()
#         #         elif escolha == 5:
#         #             break
#         #         else:
#         #             print('Escolha uma opção válida.\n')
...
#         # elif local == 5:
#         #     os.system('clear')
#         #     funcionarios_controller = Controller.ControllerFuncionario()
#         #     print('= = = = = FUNCIONÁRIOS = = = = = \n')
#         #     while True:
#         #         escolha = int(input(
#         #                     f'Escolha uma das opções para Funcionário:\n'
#         #                     f'[1] Cadastrar\n'
#         #                     f'[2] Remover\n'
#         #                     f'[3] Alterar\n'
#         #                     f'[4] Visualizar\n'
...
#         #             funcionarios_controller.cadastrar_funcionario(clt, nome, cpf, telefone, email, endereco)
                    
#         #         elif escolha == 2:
#         #             os.system('clear')
#         #             clt_funcionario = input('Digite o CLT do funcionário que deseja remover: ')
#         #             funcionarios_controller.remover_funcionario(clt_funcionario)
                    
#         #         elif escolha == 3:
#         #             os.system('clear')
#         #             nome_atual = input('Qual é o nome do funcionário que deseja alterar? ')
#         #             novo_nome = input('Digite o nome do funcionário: ')
#         #             novo_clt = (input('Digite o novo CLT: '))
#         #             novo_cpf = (input('Digite o novo CPF (11 dígitos): '))
#         #             novo_telefone = input('Digite o novo telefone (11 dígitos): ')
#         #             novo_email = input('Digite o novo email do funcionário: ')
#         #             novo_endereco = (input('Digite o endereço do funcionário: '))
#         #             funcionarios_controller.atualizar_funcionario(nome_atual, novo_clt, novo_nome, novo_cpf, novo_telefone, novo_email, novo_endereco)
                    
#         #         elif escolha == 4:
#         #             os.system('clear')
#         #             funcionarios_controller.visualizar_funcionarios()
...
#         # elif local == 6:
#         #     os.system('clear')
#         #     vendas_controller = Controller.ControllerVenda()
#         #     print('= = = = = VENDAS = = = = =\n ')
#         #     while True:
#         #         escolha = int(input(
#         #                     f'Escolha uma das opções para Venda:\n'
#         #                     f'[1] Cadastrar\n'
#         #                     f'[2] Listar vendas\n'
...
#         #         if escolha == 1:
#         #             os.system('clear')
#         #             nome_produto = input('Qual produto foi vendido? ')
#         #             vendedor = input('Quem foi o vendedor? ')
#         #             comprador = (input('Quem foi o cliente comprador? '))
#         #             quantidade_vendida = (input('Quantas unidades deste produto foram vendidas? '))
#         #             vendas_controller.cadastrar_venda(nome_produto, vendedor, comprador, quantidade_vendida)
#         #         elif escolha == 2:
#         #             os.system('clear')
#         #             data_inicial = input('Digite a data inicial do relatório no formato dd/mm/aaaa: ')
#         #             data_final = input('Digite a data final do relatório no formato dd/mm/aaaa: ')
#         #             vendas_controller.mostrar_venda(data_inicial, data_final)
#         #         elif escolha == 3:
#         #             break
#         #         else:
#         #             print('Escolha uma opção válida.\n')
...
#         #     vendas_controller = Controller.ControllerVenda()
#         #     print('\n= = = = = RELATÓRIO DE VENDAS = = = = = \n')
#         #     vendas_controller.relatorio_produtos()
#         #     break
